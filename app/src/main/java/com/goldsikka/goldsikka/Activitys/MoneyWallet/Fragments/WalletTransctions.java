...
public class WalletTransctions extends Fragment implements SwipeRefreshLayout.OnRefreshListener, OnItemClickListener {
    LinearLayout linearlayout;
    LinearLayout  llrv;
    RecyclerView rveventlist;

    ArrayList<EventModel> arrayList;
    Wallet_TransctionAdapter adapter;
    ApiDao apiDao;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(R.layout.wallet_transctions,container,false);
    ...
    public void intilizerecyclerview(View view){
        ...
        adapter = new Wallet_TransctionAdapter(activity,arrayList,this);
...
//        loadeventsdetails();
//        //Toast.makeText(activity, "OnActivity Created", Toast.LENGTH_SHORT).show();
//    }
    ...
    public void loadeventsdetails() {
        ...
        if (!NetworkUtils.isConnected(activity)){
            ...
            apiDao = ApiClient.getClient(AccountUtils.getAccessToken(activity)).create(ApiDao.class);
            Call<EventModel> getdetails = apiDao.wallet_transction_list("Bearer "+AccountUtils.getAccessToken(activity));
...
//
    ...
    public void Apicall_page(){
        ...
        if (!NetworkUtils.isConnected(activity)){
            ...
            apiDao = ApiClient.getClient(AccountUtils.getAccessToken(activity)).create(ApiDao.class);
            Call<EventModel> getdetails = apiDao.walletlistnextpage("Bearer "+AccountUtils.getAccessToken(activity), String.valueOf(next_page));
            getdetails.enqueue(new Callback<EventModel>() {
                @Override
                public void onResponse(Call<EventModel> call, Response<EventModel> response) {
                    int statuscode  = response.code();

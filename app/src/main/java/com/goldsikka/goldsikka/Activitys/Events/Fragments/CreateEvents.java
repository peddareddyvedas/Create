...
import com.goldsikka.goldsikka.Activitys.Events.EventConformation;
...
public class CreateEvents extends AppCompatActivity {
    ...
    public void setHint() {
        ...
        etholdername.setHint(Html.fromHtml(getString(R.string.event_holder_name)));
        ...
        etotheventname.setHint(Html.fromHtml(getString(R.string.other_event_type)));

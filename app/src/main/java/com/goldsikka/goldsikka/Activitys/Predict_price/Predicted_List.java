...
//
                            ...
                            dialog.dismiss();
                            ToastMessage.onToast(Predicted_List.this, "No Data Avalable..", ToastMessage.ERROR);
                        }
                ...
                public void onResponse(@NonNull Call<PredictionListModel> call, @NonNull retrofit2.Response<PredictionListModel> response) {
                    ...
                    if (stauscode == HttpsURLConnection.HTTP_CREATED || stauscode == HttpsURLConnection.HTTP_OK) {
                        ...
                        if (listmodel.size() != 0) {
                            ...
                            linearlayout.setVisibility(View.VISIBLE);
                            dialog.dismiss();
                            ToastMessage.onToast(Predicted_List.this, "No Data Avalable..", ToastMessage.SUCCESS);
                        }
                    } else {
                        try {
                            assert response.errorBody() != null;

...
import com.goldsikka.goldsikka.Enum.Passwordcalculation_Enum;
...
//        });
            ...
            new AlertDialog.Builder(this)
                    ...
                    .setPositiveButton("ok", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            ActivityCompat.requestPermissions(RegistationActivity.this,
    ...
    public void validations(View view) {
        ...
        if (subcategory.equals("Select Wallet")) {
            ...
            Call<Listmodel> call = apiDao.getsignup(stname, stemail, stmobile, stpassword, stconfirmpassword,
                    rs_roleid, streferralcode, "1", rspknow, stknowothers, "Android", appVersion, androidVersion, uuid, device_token);
            responsemethod(call);
        }
    }
...
//
    ...
    public void orgvalidation() {
        ...
        if (subcategory.equals("Select Wallet")) {
            ...
            rbstoppassword = RequestBody.create(MediaType.parse("text/plain"), stoppassword);
            rbstopconfirmpassword = RequestBody.create(MediaType.parse("text/plain"), stopconfirmpassword);
            ...
            rbuuid = RequestBody.create(MediaType.parse("text/plain"), uuid);
...
//                    for (Listmodel listmodel:list){
    ...
    public void sendregdata() {
        ...
        Call<Listmodel> sendregdata = apiDao.orggetsignup(rqroltype, rbstorgtypenumber, rbstorgname, rbstorgaddress, rbstorgcity, rbstate_id
                ...
                rbknow, rbotherknow, rbdtype, rbappversiod, rbandroidversion, rbuuid, rbdtoken);

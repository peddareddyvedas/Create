...
public class Edit_CustomerAddress extends AppCompatActivity implements View.OnClickListener {
    Button bt_Add;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_edit__customer_address);
        ...
        fromcartlist = bundle.getString("from");
...
//        setTitle("Edit Address");
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (item.getItemId() == android.R.id.home) {
            if (fromcartlist.equals("profileedit")){
                Intent intent = new Intent(this, Profile_Details.class);
                intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK);
                startActivity(intent);
            }
            Bundle bundle1 = new Bundle();
            bundle1.putString("fromcartlist",fromcartlist);
            bundle1.putString("fromto",fromto);
            customer_addresslist address_coustomer = new customer_addresslist();
            address_coustomer.setArguments(bundle1);
            getSupportFragmentManager().beginTransaction().replace(R.id.frame_layout,address_coustomer).commit();
            //onBackPressed();
        }
...
//                        spinner_state.setSelection(spinnerPosition);
                    ...
                    dialog.dismiss();
                    ToastMessage.onToast(Edit_CustomerAddress.this,"Server Error",ToastMessage.ERROR);
                }
            }
            ...
            public void onFailure(Call<Listmodel> call, Throwable t) {
                dialog.dismiss();
                ToastMessage.onToast(Edit_CustomerAddress.this,"We have some issues",ToastMessage.ERROR);
            }
        });
    }
    ...
    public void spinnerclick(){
        ...
        spinner_address_type.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                ((TextView) view).setTextColor(ContextCompat.getColor(Edit_CustomerAddress.this, R.color.textcolorprimary));
...
//                    }
    ...
    public void loaddata(){
        ...
        get_address.enqueue(new Callback<List<Listmodel>>() {
                ...
                if (statuscode == HttpsURLConnection.HTTP_OK) {
                    for (Listmodel listmodel : list) {
                      ...
                      // codee = listmodel.getCode();
                        ...
                        adapter = new ArrayAdapter<String>(Edit_CustomerAddress.this, android.R.layout.simple_spinner_dropdown_item, statelist);
            ...
            public void onFailure(Call<List<Listmodel>> call, Throwable t) {
                ...
                ToastMessage.onToast(Edit_CustomerAddress.this,"Technical Issues",ToastMessage.ERROR);
                dialog.dismiss();
            }
        });
    ...
    public void init_validation(){
        ...
        timer.schedule(new TimerTask() {
            ...
            public void run() {
                ...
                Edit_CustomerAddress.this.runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
                        validations();
    ...
    private void validations() {
        ...
        if(subcategory.equals("Select Address Type")){
            ...
            tv_pin.setText("Please enter pincode");
        }
        else {
            setaddress();
        }
        ...
        edit_address.enqueue(new Callback<Listmodel>() {
            ...
            public void onResponse(Call<Listmodel> call, Response<Listmodel> response) {
                ...
                if (statuscode == HttpsURLConnection.HTTP_CREATED||statuscode == HttpsURLConnection.HTTP_OK||
                    ...
                    for (Listmodel listmodel : list){
                        dialog.dismiss();
                        ToastMessage.onToast(Edit_CustomerAddress.this,"Successfully Updated..",ToastMessage.SUCCESS);
                        onsuccess();
                    ...
                    try {
                      ...
                      //  tv_state.setVisibility(View.GONE);
                        ...
                        ToastMessage.onToast(Edit_CustomerAddress.this, st, ToastMessage.ERROR);

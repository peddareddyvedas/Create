...
public class WomensplActivity extends AppCompatActivity {
...
TextView unameTv, uidTv, titleTv;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_womenspl);

        ButterKnife.bind(this);

        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar);
        setSupportActionBar(toolbar);
//        setTitle("Women's Day Special");
        ...
        titleTv.setText("Women's Day Special");
    ...
    public void initvalidation(){
        ...
        timer.schedule(new TimerTask() {
            ...
            public void run() {
                ...
                WomensplActivity.this.runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
                        if (!NetworkUtils.isConnected(WomensplActivity.this)){
                            ToastMessage.onToast(WomensplActivity.this, getString(R.string.error_no_internet_connection), ToastMessage.ERROR);
                            return;
                        }else {
                            validation();
    ...
    public void validation(){
        ...
        if (stname.isEmpty()){
            ...
            tvmobile.setText("Please Enter the Mobile Number.");
        }
    ...
    public void initEnquiryForm(){
        ...
        Call<Enquiryformmodel> contactus = apiDao.womensplapi(stname,stemail,stmobile,stcity,stmessage,"3");
        contactus.enqueue(new Callback<Enquiryformmodel>() {
            ...
            public void onResponse(Call<Enquiryformmodel> call, Response<Enquiryformmodel> response) {
                ...
                if (statuscode == HttpsURLConnection.HTTP_OK||statuscode == HttpsURLConnection.HTTP_ACCEPTED
                    ...
                    try {
                        ...
                        ToastMessage.onToast(WomensplActivity.this,msg,ToastMessage.ERROR);
            ...
            public void onFailure(Call<Enquiryformmodel> call, Throwable t) {
                dialog.dismiss();
                ToastMessage.onToast(WomensplActivity.this, "We have some issues ",ToastMessage.ERROR);
            }
        });
    }
    ...
    public void popup(String msg){
        ...
        btcountinue.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(WomensplActivity.this, MainActivity.class);
    ...
    public void initterms(){
            openwebpage("https://goldsikka.com/womens-day-special-offer");
    }

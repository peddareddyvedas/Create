...
public class Predict_EditAddress extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_predict__edit_address);
...
//        setTitle("Edit Address");
    ...
    private void set_previousdetails() {
        ...
        if (!NetworkUtils.isConnected(this)){
            ...
            Call<Listmodel> setaddress_details = apiDao.get_address("Bearer " + AccountUtils.getAccessToken(this), addressid);
...
//                        spinner_state.setSelection(spinnerPosition);
                        ...
                        dialog.dismiss();
                        ToastMessage.onToast(Predict_EditAddress.this, "Server Error", ToastMessage.ERROR);
                    }
                }
                ...
                public void onFailure(Call<Listmodel> call, Throwable t) {
                    dialog.dismiss();
                    ToastMessage.onToast(Predict_EditAddress.this, "We have some issues", ToastMessage.ERROR);
                }
            });
        }
    }
    ...
    public void spinnerclick(){
        ...
        spinner_address_type.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                ((TextView) view).setTextColor(ContextCompat.getColor(Predict_EditAddress.this, R.color.textcolorprimary));
...
//                    }
        ...
        if (!NetworkUtils.isConnected(this)){
            ...
            get_address.enqueue(new Callback<List<Listmodel>>() {
                ...
                public void onResponse(Call<List<Listmodel>> call, Response<List<Listmodel>> response) {
                    ...
                    if (statuscode == HttpsURLConnection.HTTP_OK) {
                        for (Listmodel listmodel : list) {
                            ...
                            adapter = new ArrayAdapter<String>(Predict_EditAddress.this, android.R.layout.simple_spinner_dropdown_item, statelist);
                ...
                public void onFailure(Call<List<Listmodel>> call, Throwable t) {
                    ...
                    ToastMessage.onToast(Predict_EditAddress.this, "Technical Issues", ToastMessage.ERROR);
                    dialog.dismiss();
                }
            });
        }
    ...
    public void init_validation(){
        ...
        timer.schedule(new TimerTask() {
            ...
            public void run() {
                ...
                Predict_EditAddress.this.runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
                        validations();
            ...
            edit_address.enqueue(new Callback<Listmodel>() {
                ...
                public void onResponse(Call<Listmodel> call, Response<Listmodel> response) {
                    ...
                    if (statuscode == HttpsURLConnection.HTTP_CREATED || statuscode == HttpsURLConnection.HTTP_OK ||
                        ...
                        for (Listmodel listmodel : list) {
                            dialog.dismiss();
                            ToastMessage.onToast(Predict_EditAddress.this, "Successfully Updated..", ToastMessage.SUCCESS);
                            onsuccess();
                        ...
                        try {
                            ...
                            ToastMessage.onToast(Predict_EditAddress.this, st, ToastMessage.ERROR);
    ...
    public void onsuccess(){
        ...
        if (!NetworkUtils.isConnected(this)){
            ...
            Intent intent = new Intent(Predict_EditAddress.this, MainActivity.class);
            startActivity(intent);
        }
    }
}
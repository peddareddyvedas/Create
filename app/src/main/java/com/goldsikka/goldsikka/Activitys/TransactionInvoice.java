...
//                            downloadZipFileTask.execute(response.body());
                        ...
                        dialog.dismiss();
                        ToastMessage.onToast(TransactionInvoice.this,"Technical Issue Try after some time  ",ToastMessage.ERROR);
                    }
                }
                ...
                public void onFailure(Call<ResponseBody> call, Throwable t) {
                    ...
                    ToastMessage.onToast(TransactionInvoice.this,"We have some issues Try after some time ",ToastMessage.ERROR);
    ...
    private class DownloadZipFileTask extends AsyncTask<ResponseBody, Pair<Integer, Long>, String> {
        ...
        protected void onProgressUpdate(Pair<Integer, Long>... progress) {
            ...
            ToastMessage.onToast(TransactionInvoice.this,"File downloaded in Goldsikka Folder",ToastMessage.SUCCESS);
            ...
            if (progress[0].first == -1) {
                ...
                ToastMessage.onToast(TransactionInvoice.this,"Download failed Try Again",ToastMessage.ERROR);

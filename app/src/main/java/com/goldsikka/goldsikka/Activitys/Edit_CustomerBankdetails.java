...
public class Edit_CustomerBankdetails extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_edit__customer_bankdetails);
...
//        setTitle("Edit Bank Details");
        ...
        set_previousdetails.enqueue(new Callback<Listmodel>() {
            ...
            public void onResponse(Call<Listmodel> call, Response<Listmodel> response) {
                ...
                if (statuscode == HttpsURLConnection.HTTP_CREATED||statuscode==HttpsURLConnection.HTTP_OK||statuscode == HttpsURLConnection.HTTP_ACCEPTED){
                    ...
                    dialog.dismiss();
                    ToastMessage.onToast(Edit_CustomerBankdetails.this,"Serever error",ToastMessage.ERROR);
                }
            }
            ...
            public void onFailure(Call<Listmodel> call, Throwable t) {
                dialog.dismiss();
                ToastMessage.onToast(Edit_CustomerBankdetails.this,"We have some issues",ToastMessage.ERROR);
            }
        });
    }
      ...
      //  loading_gif.setVisibility(View.VISIBLE);
        ...
        timer.schedule(new TimerTask() {
            ...
            public void run() {
                ...
                Edit_CustomerBankdetails.this.runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
                        validation();
        ...
        editdetails.enqueue(new Callback<Listmodel>() {
            ...
            public void onResponse(Call<Listmodel> call, Response<Listmodel> response) {
                ...
                if (statuscode == HttpsURLConnection.HTTP_CREATED||statuscode == HttpsURLConnection.HTTP_OK||statuscode==HttpsURLConnection.HTTP_ACCEPTED){
                    for (Listmodel listmodel : list){
                        dialog.dismiss();
                        ToastMessage.onToast(Edit_CustomerBankdetails.this,"Successfully Updated..",ToastMessage.SUCCESS);
                        onsuccess();
                    }
                }
                else {
                    try {
                        ...
                        ToastMessage.onToast(Edit_CustomerBankdetails.this, st, ToastMessage.ERROR);
    ...
    private void onsuccess() {
        if (from.equals("profileedit")){
            Intent intent = new Intent(this, Profile_Details.class);

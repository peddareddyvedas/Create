...
public class AddBankDetailsForReferral extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_bank_details_for_referral);
...
//        setTitle("Add your Bank Details");
    ...
    public void init_validation(){
        ...
        timer.schedule(new TimerTask() {
            ...
            public void run() {
                ...
                AddBankDetailsForReferral.this.runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
                        validation();
                ...
                public void onResponse(Call<Listmodel> call, Response<Listmodel> response) {
                    ...
                    if (statuscode == HttpsURLConnection.HTTP_OK || statuscode == HttpsURLConnection.HTTP_CREATED || statuscode == HttpsURLConnection.HTTP_ACCEPTED) {
                        ...
                        for (Listmodel listmodel : list) {
                            dialog.dismiss();
                            onsuccess();
                            ToastMessage.onToast(AddBankDetailsForReferral.this, "successfully added", ToastMessage.SUCCESS);
                        ...
                        try {
                            ...
                            ToastMessage.onToast(AddBankDetailsForReferral.this, st, ToastMessage.ERROR);
    ...
    private void onsuccess() {
        Intent intent = new Intent(AddBankDetailsForReferral.this, ReferAndEarnActivity.class);

...
public class OrganizationChangePassword extends AppCompatActivity {

    @SuppressLint("NonConstantResourceId")
    @BindView(R.id.org_newpass)
    EditText et_password;

    @SuppressLint("NonConstantResourceId")
    @BindView(R.id.org_currentpass)
    EditText etcurrentpass;

    @SuppressLint("NonConstantResourceId")
    @BindView(R.id.org_confirmpass)
    EditText et_confirmpassword;

    @SuppressLint("NonConstantResourceId")
    @BindView(R.id.iv_neweye)
    ImageView ivneweye;

    @SuppressLint("NonConstantResourceId")
    @BindView(R.id.iv_currenteye)
    ImageView ivcurrenteye;

    @SuppressLint("NonConstantResourceId")
    @BindView(R.id.tvnewpasswrd)
    TextView tv_passwrd;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_organization_change_password);
    ...
    public void init_changepassword_validation(){
        ...
        timer.schedule(new TimerTask() {
            ...
            public void run() {
                ...
                OrganizationChangePassword.this.runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
    ...
    private void validation_changepassword() {
        ...
        if (st_currtntpassword.isEmpty()){
            ...
            ToastMessage.onToast( OrganizationChangePassword.this," Password Should Have 1 uppercase, 1 lowercase \n 1 Numerical And special Character",ToastMessage.NOTIFY);
        ...
        if (!NetworkUtils.isConnected(this)) {
            ...
            change_password.enqueue(new Callback<Listmodel>() {
                ...
                public void onResponse(Call<Listmodel> call, Response<Listmodel> response) {
                    ...
                    if (statuscode == HttpsURLConnection.HTTP_CREATED || statuscode == HttpsURLConnection.HTTP_OK) {
                        ...
                        for (Listmodel listmodel : list) {
                            ...
                            ToastMessage.onToast(OrganizationChangePassword.this, st_success, ToastMessage.SUCCESS);
                        ...
                        try {
                            ...
                            ToastMessage.onToast(OrganizationChangePassword.this, st, ToastMessage.ERROR);
                ...
                public void onFailure(Call<Listmodel> call, Throwable t) {
                    dialog.dismiss();
                    ToastMessage.onToast(OrganizationChangePassword.this, "We have some issues", ToastMessage.ERROR);
                }
            });
        }
            ...
            initlogout.enqueue(new Callback<List<Listmodel>>() {
                ...
                public void onResponse(Call<List<Listmodel>> call, Response<List<Listmodel>> response) {
                    ...
                    if (stauscode == HttpsURLConnection.HTTP_CREATED || stauscode == HttpsURLConnection.HTTP_OK) {
                        ...
                        Intent intent = new Intent(OrganizationChangePassword.this, WelcomeActivity.class);
                        intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK);
                        startActivity(intent);
                    } else {
                        ToastMessage.onToast(OrganizationChangePassword.this, "Technical issue", ToastMessage.ERROR);

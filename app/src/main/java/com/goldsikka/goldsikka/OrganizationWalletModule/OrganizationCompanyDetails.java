...
public class OrganizationCompanyDetails extends AppCompatActivity implements OnMapReadyCallback,View.OnClickListener{
...
String oid, oname;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.organization_companydetails);
...
//    }
    ...
    public void Requestpermissions(){
        if (ContextCompat.checkSelfPermission(OrganizationCompanyDetails.this,
                Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED){
            if (ActivityCompat.shouldShowRequestPermissionRationale(OrganizationCompanyDetails.this,
                    Manifest.permission.ACCESS_FINE_LOCATION)){
                ActivityCompat.requestPermissions(OrganizationCompanyDetails.this,
    ...
    public void onMapReady(GoogleMap googleMap) {
        LatLng goldsikka = new LatLng(17.394873228060472,78.48887941284222);

...
public class OrganizationAddBankDetails extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.organization_addbank_details);
...
//        setTitle("Add  Bank Details");
    ...
    public void init_validation(){
        ...
        timer.schedule(new TimerTask() {
            ...
            public void run() {
                ...
                OrganizationAddBankDetails.this.runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
                        validation();
        ...
        if (!NetworkUtils.isConnected(this)) {
            ...
            get_bankdetails.enqueue(new Callback<Listmodel>() {
                ...
                public void onResponse(Call<Listmodel> call, Response<Listmodel> response) {
                    ...
                    if (statuscode == HttpsURLConnection.HTTP_CREATED || statuscode == HttpsURLConnection.HTTP_OK ||
                        ...
                        for (Listmodel listmodel : list) {
                            ...
                            dialog.dismiss();
                            ToastMessage.onToast(OrganizationAddBankDetails.this, "successfully added", ToastMessage.SUCCESS);
                            onsuccess();
                        }
                    } else {
                        try {
                            ...
                            ToastMessage.onToast(OrganizationAddBankDetails.this, st, ToastMessage.ERROR);
                ...
                public void onFailure(Call<Listmodel> call, Throwable t) {
                    ToastMessage.onToast(OrganizationAddBankDetails.this, "We Have Some Issues", ToastMessage.ERROR);
                    dialog.dismiss();
                }
            });
        }
    ...
    private void onsuccess() {
        if (!NetworkUtils.isConnected(this)) {
           ...
           Intent intent = new Intent(OrganizationAddBankDetails.this, OrganizationBankDetails.class);

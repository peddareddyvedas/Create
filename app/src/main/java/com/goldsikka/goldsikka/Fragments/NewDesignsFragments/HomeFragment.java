...
//    public ActionBarDrawerToggle actionBarDrawerToggle;
    ...
    private FancyShowCaseView sidemenuShowView, buyGoldShowView, addMoneyShowView, jewelleryshowview, sellgoldsShocaseview, transferShowView, redeemShocaseview, goldchitShowView, goldplusShowView;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        sidemenuShowView = new FancyShowCaseView.Builder(getActivity())
                .focusOn(ivmenu)
                .customView(R.layout.showcaseanim, new OnViewInflateListener() {
                    @Override
                    public void onViewInflated(@NonNull View view) {
                        setAnimatedContent(view, sidemenuShowView);
                    }
                })
                .build();
...
//        ivprofileimg.setOnClickListener(this);
        ...
        buyGoldShowView = new FancyShowCaseView.Builder(getActivity())
                .focusOn(btbuygold)
                .customView(R.layout.showcaseanim, new OnViewInflateListener() {
                    @Override
                    public void onViewInflated(@NonNull View view) {
                        setAnimatedContent(view, buyGoldShowView);
                    }
                })
                .build();
        addMoneyShowView = new FancyShowCaseView.Builder(getActivity())
                .focusOn(btaddmoney)
                .customView(R.layout.showcaseanim, new OnViewInflateListener() {
                    @Override
                    public void onViewInflated(@NonNull View view) {
                        setAnimatedContent(view, addMoneyShowView);
                    }
                })
                .build();


        transferShowView = new FancyShowCaseView.Builder(getActivity())
                .focusOn(llfragmentsellgold)
                .customView(R.layout.showcaseanim, new OnViewInflateListener() {
                    @Override
                    public void onViewInflated(@NonNull View view) {
                        setAnimatedContent(view, transferShowView);
                    }
                })
                .build();
        sellgoldsShocaseview = new FancyShowCaseView.Builder(getActivity())
                .focusOn(lltransfer)
                .customView(R.layout.showcaseanim, new OnViewInflateListener() {
                    @Override
                    public void onViewInflated(@NonNull View view) {
                        setAnimatedContent(view, sellgoldsShocaseview);
                    }
                })
                .build();


        redeemShocaseview = new FancyShowCaseView.Builder(getActivity())
                .focusOn(llredeem)
                .customView(R.layout.showcaseanim, new OnViewInflateListener() {
                    @Override
                    public void onViewInflated(@NonNull View view) {
                        setAnimatedContent(view, redeemShocaseview);
                    }
                })
                .build();
        jewelleryshowview = new FancyShowCaseView.Builder(getActivity())
                .focusOn(lljewelleryinv)
                .customView(R.layout.showcaseanim, new OnViewInflateListener() {
                    @Override
                    public void onViewInflated(@NonNull View view) {
                        setAnimatedContent(view, jewelleryshowview);
                        setscrollfun();
                    }
                })
                .build();
        ...
        goldchitShowView = new FancyShowCaseView.Builder(getActivity())
                .focusOn(llschemee)
                .customView(R.layout.showcaseanim, new OnViewInflateListener() {
                    @Override
                    public void onViewInflated(@NonNull View view) {
                        setAnimatedContent(view, goldchitShowView);
                    }
                })
                .build();


        goldplusShowView = new FancyShowCaseView.Builder(getActivity())
                .focusOn(llevent)
                .customView(R.layout.showcaseanim, new OnViewInflateListener() {
                    @Override
                    public void onViewInflated(@NonNull View view) {
...
//                            Toast.makeText(activity, st, Toast.LENGTH_SHORT).show();
    ...
    private void setupSlider(View view) {
        ...
        viewPager.setAdapter(new PageviewAdapter(getActivity(), urls));
    ...
    public void setAnimatedContent(final View view, final FancyShowCaseView fancyShowCaseView) {
        new Handler().postDelayed(new Runnable() {
            ...
            public void run() {
                ...
                if (fancyShowCaseView == (sidemenuShowView)) {
                    tvMain.setText("Side Menu");
                    tvSub.setText("Display all available options");
                    tvNext.setText("Next");
                } else if (fancyShowCaseView == (buyGoldShowView)) {
                    tvMain.setText("Buy Gold");
                    tvSub.setText("You can buy the gold through online the gold add in your wallet ");
                    tvNext.setText("Next");
                } else if (fancyShowCaseView == (addMoneyShowView)) {
                    tvMain.setText("Add Money");
                    tvSub.setText("Add Money in your wallet ");
                    tvNext.setText("Next");
                } else if (fancyShowCaseView == (sellgoldsShocaseview)) {
                    tvMain.setText("Transfer");
                    tvSub.setText("Transfer the Gold From Your Wallet instantly");
                    tvNext.setText("Next");
                } else if (fancyShowCaseView == (transferShowView)) {
                    tvMain.setText("Sell Gold");
                    tvSub.setText("You can sell the gold through online the gold in your wallet ");
                    tvNext.setText("Next");
                } else if (fancyShowCaseView == (redeemShocaseview)) {
                    tvMain.setText("Redeem");
                    tvSub.setText("In Redeem Transfer Gold in gram only");
                    tvNext.setText("Next");
                } else if (fancyShowCaseView == (goldchitShowView)) {
                    tvMain.setText("Gold Chit");
                    tvSub.setText("Gold Chit Scheam for selection");
                    tvNext.setText("Next");

                } else if (fancyShowCaseView == (goldplusShowView)) {
                    tvMain.setText("Events");
                    tvSub.setText("Gold Chit Scheam for selection");
                    tvNext.setText("Next");

                } else if (fancyShowCaseView == (jewelleryshowview)) {
                    tvMain.setText("Jewellery");
                    tvSub.setText("Jewellery Inventory so many products is available");
                    tvNext.setText("Done");
                    sharedPreference.WriteLoginStatus(true);
                    AccountUtils.setShowCaseInfo(getActivity(), "ShowCaseInfo");
                }
...
//                        mQueue.cancel(true);
                ...
                final Animation mainAnimation = AnimationUtils.loadAnimation(getActivity(), R.anim.slide_in_left);
                mainAnimation.setFillAfter(true);
                final Animation subAnimation = AnimationUtils.loadAnimation(getActivity(), R.anim.slide_in_left);
    ...
    public void focus() {
        ...
        mQueue.add(sidemenuShowView);
        mQueue.add(buyGoldShowView);
        mQueue.add(addMoneyShowView);
        mQueue.add(sellgoldsShocaseview);
        mQueue.add(transferShowView);
        mQueue.add(redeemShocaseview);
        mQueue.add(jewelleryshowview);
        mQueue.show();
    }
}

...
public class AddAddressForReedemModule extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_address_for_reedem_module);
...
//        setTitle("Address");
    ...
    public void intilizeviews(){
        ...
        ArrayAdapter spinner_adapter = new ArrayAdapter(AddAddressForReedemModule.this, android.R.layout.simple_spinner_item,st_address_type);
    ...
    public void spinner_stateclick(){
        ...
        spinner_state.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                ((TextView) view).setTextColor(ContextCompat.getColor(AddAddressForReedemModule.this, R.color.textcolorprimary));
            ...
            get_address.enqueue(new Callback<List<Listmodel>>() {
                ...
                public void onResponse(Call<List<Listmodel>> call, Response<List<Listmodel>> response) {
                    ...
                    if (statuscode == HttpsURLConnection.HTTP_OK) {
                        ...
                        spinner_state.setAdapter(new ArrayAdapter<String>(AddAddressForReedemModule.this, android.R.layout.simple_spinner_dropdown_item,
                                statelist));
                ...
                public void onFailure(Call<List<Listmodel>> call, Throwable t) {
                    ToastMessage.onToast(AddAddressForReedemModule.this, "We Have Some Issues", ToastMessage.ERROR);
                    dialog.dismiss();
                }
            });
        }
    ...
    public void initvalidation(){
        ...
        timer.schedule(new TimerTask() {
            ...
            public void run() {
                ...
                AddAddressForReedemModule.this.runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
                        validation();
    ...
    public void validation(){
        ...
        if(subcategory.equals("Select Address Type")){
            ToastMessage.onToast(AddAddressForReedemModule.this, "Please Select Address Type", ToastMessage.ERROR);
        }
            ...
            ToastMessage.onToast(AddAddressForReedemModule.this, "Please Select State", ToastMessage.ERROR);
        }
                ...
                public void onResponse(Call<Listmodel> call, Response<Listmodel> response) {
                    ...
                    if (statuscode == HttpsURLConnection.HTTP_CREATED || statuscode == HttpsURLConnection.HTTP_OK) {
                        for (Listmodel listmodel : list) {
                            ...
                            dialog.dismiss();
                            ToastMessage.onToast(AddAddressForReedemModule.this, "Successfully added", ToastMessage.SUCCESS);
                            onsuccess();
                        }
                    } else {
...
//                            ToastMessage.onToast(AddAddressForReedemModule.this, st, ToastMessage.ERROR);
    ...
    public void onsuccess(){
        if (!NetworkUtils.isConnected(this)){
            ...
            Intent intent = new Intent(AddAddressForReedemModule.this, Reedem_fragment.class);
